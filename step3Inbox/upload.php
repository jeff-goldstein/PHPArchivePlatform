...
function extract_data($verb, &$fileContent, $DefaultTimeZone, &$original_to, &$headerDate, &$subject, &$from, &$sendDateTime, $inputField, &$UID, &$html)
{
    ...
    if ($verb == "POST") 
    {
        ...
        file_put_contents("uploadhtml.html", $html);
...
extract_data($verb, $fileContent, $DefaultTimeZone, $original_to, $headerDate, $subject, $from, $sendDateTime, $inputField, $UID, $html);
